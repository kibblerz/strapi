...
module.exports = {
  ...
  async init() {
    ...
    const projectSettings = await getService('project-settings').getProjectSettings();
    const menuLogo = projectSettings ? (projectSettings.menuLogo ? menuLogo.url : null) : null;

    return { data: { uuid, hasAdmin, menuLogo } };
  },
